package com.nanda.notesapp.ui.detail
...
import com.nanda.notesapp.databinding.FragmentDetailBinding
...
class DetailFragment : Fragment() {
    ...
    private fun confirmDeleteNote() {
        context?.let {
            AlertDialog.Builder(it).setTitle("Delete '${args.currentItem.title}'?")
                .setMessage("If you sure want to remove '${args.currentItem.title}'. it will be delete for permanent")
                .setPositiveButton("of course") { _, _ ->
                    detailViewModel.deleteNote(args.currentItem)
